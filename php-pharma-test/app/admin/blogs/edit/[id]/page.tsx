  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch blog data
        const blogData = await blogApi.getById(blogId);
          ...
          <div className="lg:col-span-3 space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-3 text-xl font-medium border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-600 transition-all text-black"
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="flex-1 px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-600 transition-all text-black"
            ...
            <div className="space-y-4">
              ...
              {formData.sections.map((section, index) => (
                ...
                >
                  <div className="bg-linear-to-r from-primary-50 to-secondary-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <span className="flex items-center justify-center w-8 h-8 bg-linear-to-r from-primary-600 to-primary-700 text-white font-bold rounded-lg text-sm">
                        {index + 1}
                      </span>
                  ...
                  <div className="p-6 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-600 transition-all text-black"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-600 transition-all bg-gray-50 text-black"
                    ...
                    <div>
                      ...
                      <TiptapEditor
                        ...
                        placeholder={`Viết nội dung cho phần ${index + 1}...`}
