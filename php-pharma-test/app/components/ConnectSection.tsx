            ...
            <div className="relative z-10 text-center p-6 max-w-md">
              <p className="text-gray-700 mb-2">
                <span className="font-semibold">
                  {t.connect.partnersWorldwide}
                </span>
              </p>
              <p className="text-gray-700 mb-4">
                <span className="font-semibold">
                  {t.connect.fullyTrained}
                </span>
              </p>
              <Link
                href="/distributors"
                className="inline-block bg-primary-900 text-white px-6 py-2 rounded hover:bg-primary-800 transition-colors text-sm"
              >
                {t.connect.findLocalReps}
              </Link>
            </div>
          </div>
        </div>
